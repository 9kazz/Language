...
// {
//     FILL_ONE_TOKEN ( "партия",                   _FUNC_INIT_),
//     FILL_ONE_TOKEN ( "нота",                     _VAR_INIT_),
//     FILL_ONE_TOKEN ( "слышно, что",              _OPEN_BRACK_),
//     FILL_ONE_TOKEN ( "нужно",                    _CLOSE_BRACK_),
//     FILL_ONE_TOKEN ( "вступить:",                _BEGIN_OPER_),
//     FILL_ONE_TOKEN ( "отзвучать",                _END_OPER_),
//     FILL_ONE_TOKEN ( ", ритмическая пауза",      _END_STATEMENT_),
//     FILL_ONE_TOKEN ( ",",                        _COMMA_),
//     FILL_ONE_TOKEN ( "звучит в унисон с",        _LOG_EQUAL_),
//     FILL_ONE_TOKEN ( "звучит в диссонанс с",     _LOG_NOT_EQUAL_),
//     FILL_ONE_TOKEN ( "звучит не тише, чем",      _LOG_MORE_EQUAL_),
//     FILL_ONE_TOKEN ( "звучит не громче, чем",    _LOG_LESS_EQUAL_),
//     FILL_ONE_TOKEN ( "звучит крещендо с",        _LOG_MORE_),
//     FILL_ONE_TOKEN ( "звучит диминуэндо с",      _LOG_LESS_),
//     FILL_ONE_TOKEN ( "звучит как",               _ASSIGNMENT_),
//     FILL_ONE_TOKEN ( "Овации!",                  _RETURN_),
//     FILL_ONE_TOKEN ( "акцентировать" ,           _PRINT_),
//     FILL_ONE_TOKEN ( "когда",                    _IF_),
//     FILL_ONE_TOKEN ( "else",                     _ELSE_),
//     FILL_ONE_TOKEN ( "пока",                     _WHILE_),
//     FILL_ONE_TOKEN ( "$",                        _END_PROGRAM_),
    
//     FILL_ONE_TOKEN ( "форте",                    _MATH_ADD_),
//     FILL_ONE_TOKEN ( "пиано",                    _MATH_SUB_),
//     FILL_ONE_TOKEN ( "мажор",                    _MATH_MUL_),
//     FILL_ONE_TOKEN ( "минор",                    _MATH_DIV_),
//     FILL_ONE_TOKEN ( "аллегро",                  _MATH_POW_),
//     FILL_ONE_TOKEN ( "стаккато",                 _MATH_SQRT_),
...
//     FILL_ONE_TOKEN ( "Импровизация!",            _DRAW_)
// };
...
Token_info Token_Info_Arr[] =
{
    ...
    FILL_ONE_TOKEN ( "!=",     _LOG_NOT_EQUAL_),
    FILL_ONE_TOKEN ( "more=",  _LOG_MORE_EQUAL_),
    FILL_ONE_TOKEN ( "less=",  _LOG_LESS_EQUAL_),
